...
export default function Footer(){
    return (
        ...
        <a class="col-md-4" href="mailto: keithmurphy.dev@gmail.com" target="_blank" rel="noreferrer"  ><img src="https://img.icons8.com/ios-glyphs/60/000000/email.png" alt="email"/></a>
